package com.mlombog.kafka.producer;
...
import com.mlombog.kafka.config.KafkaConfiguration;
import com.mlombog.kafka.config.TwitterConfiguration;
import com.mlombog.kafka.model.Tweet;
import com.mlombog.kafka.producer.callback.BasicCallback;
...
public class TwitterKafkaProducer {
	...
	public void run() throws JsonSyntaxException, InterruptedException {
		client.connect();
